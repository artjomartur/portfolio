...
const PROJECTS = [
  ...
  },
  {
    id: 'atoss-sync',
    title: 'ATOSS Sync',
    short: 'Automatisierte Synchronisation von ATOSS-Dienstplänen in den persönlichen Kalender.',
    image: '/atoss_sync.png',
    details: {
      role: 'Backend Developer & Automation',
      context: 'Automatisierung (Open-Source)',
      impact: 'Zeitersparnis und Vermeidung manueller Übertragungsfehler',
      tech: 'Node.js, iCal Generator',
      languages: ['JavaScript'],
      challenge: 'Dienstpläne automatisch und zuverlässig in einen digitalen Kalender übertragen.',
      solution: 'Ein Skript, das den ATOSS-Plan extrahiert, verarbeitet und einen iCal-Feed bereitstellt.',
      result: 'Nahtlose Kalender-Integration, die sich automatisch im Hintergrund aktualisiert.',
      tags: ['Automation', 'Backend', 'Tooling'],
